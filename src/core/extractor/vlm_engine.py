...
class HybridVerificationEngine:
    ...
    def extract_document_data(self, image_bytes: bytes) -> dict:
        ...
        prompt_text = (
            "You are an expert Indian financial forensic auditor. Analyze this government procurement document. "
            "Extract the following details in strict JSON format. Use null if a field is not present. "
            "CRITICAL: Do NOT guess, hallucinate, or repeat numbers. If you cannot clearly read a number, output null. "
            "Do not include markdown wrappers like ```json.\n"
            "{\n"
            '  "document_type": "Exact classification",\n'
            '  "vendor_name": "Name of the issuing contractor or shop (DO NOT put the project description here)",\n'
            '  "vendor_gstin": "15-character alphanumeric GSTIN or null",\n'
            '  "hsn_sac_codes": [],\n'
            '  "invoice_date": "DD/MM/YYYY or null",\n'
            '  "work_description": "The exact name of the public work or project being built",\n'
            '  "base_amount": "Numerical value STRICTLY BEFORE TAXES. Do NOT output the total here.",\n'
            '  "cgst_amount": "Central GST numerical value or 0",\n'
            '  "sgst_amount": "State GST numerical value or 0",\n'
            '  "igst_amount": "Integrated GST numerical value or 0",\n'
            '  "total_billed_amount": "Final total numerical value",\n'
